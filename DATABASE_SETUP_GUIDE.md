# Database Setup Guide for DiaBite App

## Quick Fix for Your Current Issues

You're seeing these errors because the database tables don't exist yet. Here's how to fix them:

### Step 1: Set Up Your Supabase Database

1. **Go to your Supabase project**: https://supabase.com/dashboard/project/phmmuurmjzcfbtyekhvi
...
1. **Check your terminal** - the Expo server should be running
2. **Look for the QR code** in your terminal
3. **Scan it with your phone** using Expo Go
4. **The app should now work** without database errors!

### What This Fixes

✅ **Database errors**: `relation "public.favorite_recipes" does not exist`  
✅ **Glucose logs errors**: `relation "public.glucose_logs" does not exist`  
✅ **All missing tables** will be created  
✅ **Sample recipes** will be inserted  
✅ **Security policies** will be set up  

### If You Still See Errors

If you still see the `react-native-worklets/plugin` error, try:

1. **Stop Expo** (Ctrl+C in terminal)
2. **Run**: `npx expo start --clear`
3. **Try again**

The worklets error should be resolved with the downgraded react-native-reanimated version.
